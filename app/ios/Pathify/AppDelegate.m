...
// At least, it is supposed to be. This mechanism seems brittle and seems to leaves no hints why when it doesn't work.
// Aha: It varies by target. SWIFT_MODULE_NAME is based on PRODUCT_MODULE_NAME in XCode which varies by target...
// Workaround is just to try importing either one.
